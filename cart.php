	...
	<div class="main_wrapper">
		...
		<div class="content_wrapper">
			...
			<div id="shopping_cart"> 
					...
					echo "<b>Bine ai venit:</b>" . $_SESSION['customer_email'] . "<b style='color:yellow;'></b>" ;
					}
					else {
					echo "<b>Bine ai venit:</b>";
					}
					?>
					
					<b style="color:yellow">Cosul  -</b> Total produse: <?php total_items();?> Pret total: <?php total_price(); ?> <a href="index.php" style="color:yellow">Inapoi</a>
